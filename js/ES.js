function onLoad() {
  ...
  if (month == 12) {
    for (let oct = currentDate; oct >= 1; oct--) {
      ...
      // http.send();
      if (mainData.espirtualData.December[oct]) {
        if (counter % 7 == 0 && counter != 0) {
          postDiv = postDiv + 1;
        }

        ++counter;
        if (Array.isArray(mainData.espirtualData.December[oct])) {
          console.log(mainData.espirtualData.December[oct]);
          mainData.espirtualData.December[oct].map((post, index) => {
            console.log(post);
          ...
          div.innerHTML += `<div class="post">
               <img src="${mainData.espirtualData.December[oct].img}" class="postImage" alt="">
               <div class="postDetails">
                   <h5 class="GM">${mainData.espirtualData.December[oct].title}</h5>
                   <p class="postDate GBI"><i class="fa fa-calendar"></i> ${mainData.espirtualData.December[oct].date}</p>
                   <hr>
                   <p class="postParagraph GBR">
                   ${mainData.espirtualData.December[oct].details}
                   </p>
                   <a href="${mainData.espirtualData.December[oct].route}" id='santo-link'><button class="postButton GM">LEIA MAIS</button></a>
               </div>
               </div>`;
        }
      }
  ...
  if (month == 11) {
    for (let oct = currentDate; oct >= 1; oct--) {
      ...
      // http.open("HEAD", url, false);
      // http.send();
      if (mainData.espirtualData.November[oct]) {
        if (counter % 7 == 0 && counter != 0) {
          postDiv = postDiv + 1;
        }

        ++counter;
        if (Array.isArray(mainData.espirtualData.November[oct])) {
          console.log(mainData.espirtualData.November[oct]);
          mainData.espirtualData.November[oct].map((post, index) => {
            console.log(post);
          ...
          div.innerHTML += `<div class="post">
               <img src="${mainData.espirtualData.November[oct].img}" class="postImage" alt="">
               <div class="postDetails">
                   <h5 class="GM">${mainData.espirtualData.November[oct].title}</h5>
                   <p class="postDate GBI"><i class="fa fa-calendar"></i> ${mainData.espirtualData.November[oct].date}</p>
                   <hr>
                   <p class="postParagraph GBR">
                   ${mainData.espirtualData.November[oct].details}
                   </p>
                   <a href="${mainData.espirtualData.November[oct].route}" id='santo-link'><button class="postButton GM">LEIA MAIS</button></a>
               </div>
               </div>`;
        }
      }
